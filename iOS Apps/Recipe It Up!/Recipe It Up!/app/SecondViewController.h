...
@interface SecondViewController : UIViewController <UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, CoreLocationControllerDelegate, MKMapViewDelegate, NSURLConnectionDataDelegate, UIAlertViewDelegate>
{
