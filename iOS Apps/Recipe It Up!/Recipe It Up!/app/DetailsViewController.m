...
-(IBAction)showaction
{
    popquery = [[UIActionSheet alloc] initWithTitle:@"" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:@"Save Recipe" otherButtonTitles:@"Email Recipe", @"Open in Safari", nil];
...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
	...
	if([title isEqualToString:@"Save Recipe"])
	{
        [self savFav];
    }
...
- (IBAction)savFav
{
    ...
    NSDictionary *product = [[NSDictionary alloc] initWithObjectsAndKeys: titleStr, @"title", thumbStr, @"thumb", sourceStr, @"source", linkStr, @"link", ratingStr, @"rating", nil];
